...
export const LoginComponent = () => {
  ...
  const [loginFormHook, bindLoginFormHook, setLoginFormHook] = useFormField(
    LoginLabels.loginFormDiscriminator,
    {}
  );
  ...
  return (
    <div className={"background-wave-bottom-yaco"}>
              ...
              <div className="mx-4">
                ...
                {LOGIN_FORM_DESCRIPTORS.map((descriptor, index) => (
                  <FieldFactoryComponent
                    key={index}
                    {...descriptor}
                    bind={bindLoginFormHook}
                  />
                ))}
                <p className="font-small d-flex justify-content-end pb-3">
                  <a
                    href="#"
                    className="ml-1 color-green color-text-green-yaco"
                  >
                ...
                <div className="text-center mb-3">
                  <button
                    type="button"
                    onClick={() => dispatch(doLoginAction(loginFormHook))}
